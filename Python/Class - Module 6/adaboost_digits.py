...
miRF = AdaBoostClassifier(base_estimator=GaussianNB())
miGSCV = GridSearchCV(estimator=miRF,param_grid=param_grid,scoring='accuracy',cv=StratifiedKFold(n_splits=10,random_state=3))
